  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>map함수 인자로 전달되는 함수 내부의 콤포넌트 props를 설정하는 것과 같이 작성한다.</li>
        <li>key값은 요소의 고유한 값이어야 한다. 배열 요소의 고유한 값을 사용하거나 index로 사용한다.(단, index는 배열 순서가 변경되면 index도 바뀌기 때문에 권장하지 않는다.)</li>
      </ul>
